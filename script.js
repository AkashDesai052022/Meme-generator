...
function showQuote() {
  ...
  author.innerHTML = "author: " + randomQuote.author;
  clearAll();
...
function showRiddle() {
  ...
  const riddleContainer = document.querySelector(".riddle-content");
  clearAll();
  riddleContainer.appendChild(questionElem);
  riddleContainer.appendChild(answerElem);
}
...
function revealAnswers() {
  const revealContainer = document.querySelector(".riddle-content");
  const riddle = revealContainer.querySelector("p");
  // console.log(riddle);
